    ...
    return (
        <div className='lg:mx-24 mx-3 mb-24'>
            <ul className="tabs">
                ...
                <li className={activeTab === 2 ? 'active' : ''} onClick={() => handleTabClick(2)}>2021</li>
                <li className={activeTab === 3 ? 'active' : ''} onClick={() => handleTabClick(3)}>2022</li>
                <li className={activeTab === 4 ? 'active' : ''} onClick={() => handleTabClick(4)}>2023</li>
            </ul>

            <div className="tab_content">
            <ul className="tabs">
                <li className={activeTab === 1 ? 'active' : ''} onClick={() => handleTabClick(1)}>Enero</li>
                <li className={activeTab === 2 ? 'active' : ''} onClick={() => handleTabClick(2)}>Febrero</li>
                <li className={activeTab === 3 ? 'active' : ''} onClick={() => handleTabClick(3)}>Marzo</li>
                <li className={activeTab === 4 ? 'active' : ''} onClick={() => handleTabClick(4)}>Abril</li>
                <li className={activeTab === 5 ? 'active' : ''} onClick={() => handleTabClick(5)}>Mayo</li>
                <li className={activeTab === 6 ? 'active' : ''} onClick={() => handleTabClick(6)}>Junio</li>
                <li className={activeTab === 7 ? 'active' : ''} onClick={() => handleTabClick(7)}>Julio</li>
                <li className={activeTab === 8 ? 'active' : ''} onClick={() => handleTabClick(8)}>Agosto</li>
                <li className={activeTab === 9 ? 'active' : ''} onClick={() => handleTabClick(9)}>Septiembre</li>
                <li className={activeTab === 10 ? 'active' : ''} onClick={() => handleTabClick(10)}>Octubre</li>
                <li className={activeTab === 11 ? 'active' : ''} onClick={() => handleTabClick(11)}>Noviembre</li>
                <li className={activeTab === 12 ? 'active' : ''} onClick={() => handleTabClick(12)}>Diciembre</li>
            </ul>
