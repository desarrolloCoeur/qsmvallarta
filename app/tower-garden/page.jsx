...
const Page = () => {
    ...
    const openPopup = (unit) => {
        ...
        const matchingRoomInData = dataRooms.find(room => room.title === unit.unitType);
        ...
        <>
            ...
            <section className='container w-11/12 mx-auto my-20'>
                ...
                <div className="relative">
                        <Image src="/img/tower-garden/lateral-derecho-tower-garden.webp" alt="Tower 4 - QSM" width={900} height={700} className="w-full"/>
                ...
                <div className="flex flex-col md:flex-row gap-10">
                    ...
                    <div className="md:w-1/2">
                        ...
                        {Array.isArray(selectedUnitType.plan) ? 
                            ...
                            <SwiperSlide>
                                <Image src={selectedUnitType.plan[0]} width={500} height={300} alt={selectedUnitType.title} className="h-auto"/>
                            </SwiperSlide>
                            <SwiperSlide>

                                <Image src={selectedUnitType.plan[1]} width={500} height={300} alt={selectedUnitType.title} className="h-auto"/>
                                </SwiperSlide>
                            </Swiper>
