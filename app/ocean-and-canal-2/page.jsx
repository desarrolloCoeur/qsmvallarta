...
const page = () => {
    return (
        <>
            ...
            <div className="lg:mx-24 mx-6 lg:pt-12 pt-6">
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 ">                    
                    <div>
                        <figure className="relative cursor-pointer">
                            <Image src="/img/5.webp" alt="" height={600} width={700} />
                            <div className="absolute top-0 w-full h-full hover:bg-zinc-900/70 bg-zinc-900/40 text-center">
                                <h3 className="font-semibold text-white lg:pt-44 pt-24 text-4xl">TOWER 4</h3>
                            </div>
                        </figure>
                    </div>
                    <div>
                        <figure className="relative cursor-pointer">
                            ...
                            <div className="absolute top-0 w-full h-full hover:bg-zinc-900/70 bg-zinc-900/40 text-center">
                                <h3 className="font-semibold text-white lg:pt-44 pt-24 text-4xl">TOWER 5</h3>
                            </div>
                        </figure>
                    </div>
                </div>
